...
const Services = ({ navOpen, buildClicked, secureClicked }) => {
  if (buildClicked) {
    return (
      <div className="services" id={navOpen ? "services-open" : null}>
        ...
        <div className="marquee marquee-sml">
          <span>
            ...
            users about a product, service or event. A one Page website, that
            informs users about a product, service or event.
          </span>
        </div>
